...
// la ruta creada en clasases  nuestra primera ruta
$routes->get('/hola/ruta',function(){
echo 'hola desde Routes.php';
});


// la ruta  mediante add   donde acepta metodos como el metodo post
$routes->add('/hola/add',function(){
echo 'hola desde Routes.php con add';
});


// rutas invocando a los controladores
// rutas y controladores
$routes->get('/hola/controlador', 'Hola_controller::index');


// paso de parametros
$routes->get('/hola/parametros/(:any)/(:num)',
'Hola_controller::parametrosAction/$s1,$s2');
